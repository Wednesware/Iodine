...
from iodine.highlight import PYTHON
from iodine.widgets.base import Widget
from iodine.widgets.text_input import TextInput
from iodine.widgets.multiline_input import MultilineInput
from iodine.widgets.suggest_input import SuggestInput
from iodine.widgets.syntax_input import SyntaxInput
from iodine.widgets.select import SelectMenu, Option
from iodine.keymap import Keymap
from iodine.style import Style, Theme
...
def demo_keybind_triggers():
    ...
    field = MultilineInput(prompt="Type something (F1 help, Ctrl+S save): ", line_numbers=True)
